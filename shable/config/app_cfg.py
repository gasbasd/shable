# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in shable.
...
from shable.lib import app_globals, helpers 
...
base_config.model = shable.model
base_config.DBSession = shable.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "9e80fab3-0266-4571-8185-2f0d251775b8"
